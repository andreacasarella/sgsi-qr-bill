...
class PDF_ extends extended_pdf_js_1.ExtendedPDF {
    ...
    _render() {
        ...
        if (this._separate) {
            if (this.page.height > utils.mm2pt(105)) {
                this.fontSize(11);
                this.font("Helvetica");
                this.text(translations_js_1.default[this._language].separate, utils.mm2pt(0), this._marginTop - 12, {
        ...
        this.text(translations_js_1.default[this._language].receipt, utils.mm2pt(5), this._marginTop + utils.mm2pt(5), {
        ...
        this.fontSize(6);
        this.font("Helvetica-Bold");
        this.text(translations_js_1.default[this._language].acceptancePoint, utils.mm2pt(5), this._marginTop + utils.mm2pt(82), {
            width: utils.mm2pt(52),
            align: "right",
            lineGap: 1
        });
        ...
        this.fontSize(11);
        this.font("Helvetica-Bold");
        this.text(translations_js_1.default[this._language].paymentPart, utils.mm2pt(67), this._marginTop + utils.mm2pt(5), {
            ...
            if (this._data.additionalInformation !== undefined) {
                if (referenceType === "QRR" || referenceType === "SCOR") {
                    ...
                    if (this._data.message !== undefined) {
                        this.text(this._data.message, Object.assign(Object.assign({}, options), { lineBreak: false, ellipsis: true, height: singleLineHeight }));
                    }
                }
                else {
                    ...
                    if (this._data.message !== undefined) {
                        ...
                        this.text(this._data.message, Object.assign(Object.assign({}, options), { height: singleLineHeight * maxLinesOfMessage, lineBreak: true, ellipsis: true }));
                    }
                }
                this.text(this._data.additionalInformation, options);
            }
            else if (this._data.message !== undefined) {
                this.text(this._data.message, Object.assign(Object.assign({}, options), { height: singleLineHeight * maxLines, lineBreak: true, ellipsis: true }));
            }
            this.moveDown();
        }
        if (this._data.debtor !== undefined) {
